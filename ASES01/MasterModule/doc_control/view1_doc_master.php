...
{	 
	...
	$res=mysql_query("select * from mst_doc_ctrl");
	
	echo "<center><table  class='tabledesign' > 
	<tr>
	 <th><center>Document&nbsp;No</center></th>
	...
	echo "<tr>";
	   echo  "<td class='doc_no'><center>".$row['doc_no']."</center></td>";
    	echo  "<td class='doc_name'>".$row['doc_name']."</td>";
